...
impl<SDK: SharedAPI> RouterAPI for ROUTER<SDK> {    #[function_id("sqrt(uint256)")]
    ...
    fn ln(&self, x: U256) -> I256 {
        if x.is_zero() {
            return I256::from(i128::MIN); // Return very negative value for ln(0)
        }
        ...
        } else if result_rounded > u128::MAX as f64 {
            u128::MAX
        } else {
            result_rounded as u128
        };
    ...
    fn log2(&self, x: U256) -> I256 {
        if x.is_zero() {
            return I256::from(i128::MIN); // Return very negative value for log2(0)
        }
    ...
    fn log10(&self, x: U256) -> I256 {
        if x.is_zero() {
            return I256::from(i128::MIN); // Return very negative value for log10(0)
        }
