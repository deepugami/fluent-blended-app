...
impl<SDK: SharedAPI> RouterAPI for ROUTER<SDK> {
    ...
    fn exp(&self, x: I256) -> I256 {
        ...
        let x_i128 = x.to::<i128>();
        let x_f64 = (x_i128 as f64) / 1e18;
    ...
    fn ln(&self, x: U256) -> I256 {
        if x.is_zero() {
            ...
            return I256::unchecked_from(-1000000000000000000000i128);
        }
